...
// class Product {
//     constructor(title, price, description, imageUrl, stock, id) {
//         this.title = title;
//         this.price = price;
...
//             // return product;
//             if (product) {
//                 return new Product(product.title, product.price, product.description, product.imageUrl, product.stock, prodId);
//             }
//             return null;
//         } catch (error) {
//             throw new Error(error);
